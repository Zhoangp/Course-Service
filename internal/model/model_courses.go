...
type Course struct {
	...
	IsPaid       bool          `valid:"required~IsPaid is required" gorm:"column:is_paid"`
...
type Lecture struct {
	...
	Resource  Resource `valid:"required~Lecture resource is required" gorm:"foreignKey:LectureId;references:Id"`
}
